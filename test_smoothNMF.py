...
from palm_nmf import smoothNMF
import numpy.linalg as LA



def test_all_zero_one_iteration(output):
...
def test_all_zero_200_iterations(output):
...
def sparse_one_iteration(output):
...
def test_smooth_one_iteration(ouput):
...
def test_smooth_and_parse_one_iterations(output):
...
def test_smooth_and_parse_200_iterations(output):
...
def test_smooth_and_sparse_200_iterations_betas(output):
    # testing sparsity and smoothness, 200 iterations
